...
const REPO_OWNER = 'srijan907';
const REPO_NAME = 'KHAN-MD';
...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "📂 *〆͎ＭＲ－Ｒａｂｂｉｔ PLUGINS:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        if (m.quoted && m.quoted.key.fromMe) {
            ...
            if (/📂 \*〆͎ＭＲ－Ｒａｂｂｉｔ PLUGINS:\*/i.test(quotedText)) {
        ...
        const statusMessage = {
            image: { url: `https://files.catbox.moe/4nmdaq.jpg` }, // Replace with your image URL
